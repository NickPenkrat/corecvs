...
#--------------------------------------------------------------------------------------------
#
#   This part is for core restricted
#
#--------------------------------------------------------------------------------------------

XML_DIR="${CORE_DIR}/res-src/xml"
DST_DIR="${CORE_DIR}/res-src/xml/generated"

UTILS_DIR="../../utils-res"
WIDGETS_DIR="${UTILS_DIR}/corestructs/controlWidgets"
WIDGETS_REL_DIR="\$\${UTILSRESDIR}/corestructs/controlWidgets"

enums="stereoProvider
       featuringAlgorithm
       improvementCostType
       makePreciseAlgorithm
       preciseInterpolationType"

classes="improvementControls viFlowParameters"

ui_classes="gridGeometry 
         twoLevelGeometry 
         linearFeaturingParameters 
         featuringParameters 
         filteringParameters 
         improvementParameters
         pcaEngineParameters"
         
full_ui_classes="makePreciseParameters 
         matchingParameters
         providerParameters
         blockmatchParameters"
         
#         openCVSGMParameters
#         openCVBMParameters"

WPRIFILE="${WIDGETS_DIR}/controlWidgets.pri"

echo Preparing PRI file for widgets generated from RES-CORE \"${WPRIFILE}\" 
...
XML_DIR="${CORE_DIR}/src/xml"
DST_DIR="${CORE_DIR}/src/xml/generated"

UTILS_DIR="../../utils"
WIDGETS_DIR="${UTILS_DIR}/corestructs/controlWidgets"
WIDGETS_REL_DIR="\$\${UTILSDIR}/corestructs/controlWidgets"
