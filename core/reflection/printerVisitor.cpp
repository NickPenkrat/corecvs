...
void PrinterVisitor::visit<int,    IntField>(int &field, const IntField *fieldDescriptor)
{
    ...
    *stream << ident() << fieldDescriptor->getSimpleName() << "=" << field << endl;
}
...
{
    if (stream == NULL) return;
    *stream << ident() << fieldDescriptor->getSimpleName() << "= [";
...
{
    if (stream == NULL) return;
    *stream << ident() << fieldName << "=" << intField << endl;
}
...
{
    if (stream == NULL) return;
    *stream << ident() << fieldName << "=" << doubleField << endl;
}
...
{
    if (stream == NULL) return;
    *stream << ident() << fieldName << "=" << floatField << endl;
}
...
{
    if (stream == NULL) return;
    *stream << ident() << fieldName << "=" << boolField << endl;
}
...
{
    if (stream == NULL) return;
    *stream << ident() << fieldName << "=" << stringField << endl;
}
