...
struct ReconstructionFunctor : corecvs::SparseFunctionArgs
{
    ...
    ReconstructionFunctor(ReconstructionFixtureScene *scene, const std::vector<CameraFixture*> optimizableSubset, const ReconstructionFunctorOptimizationErrorType &error, const ReconstructionFunctorOptimizationType &optimization, bool excessiveQuaternionParametrization, const double pointErrorEstimate);
