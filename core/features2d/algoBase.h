...
/* ID of the subalgorithm */
typedef std::string PipelineAlgoType;

/* For */
typedef PipelineAlgoType DetectorType;
typedef PipelineAlgoType MatcherType;
typedef PipelineAlgoType DescriptorType;
