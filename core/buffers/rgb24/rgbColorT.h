...
namespace corecvs
{
    ...
    public:
        ...
        inline int64_t cb() const
        {
            return (int)(-0.16874 * r() - 0.33126 * g() + 0.50000 * b());
        }

        inline int64_t cr() const
        {
         ...
         *
         **/
        inline int64_t u() const
        {
            return ((-38 * r() - 74 * g() + 112 * b() + 128) >> 8) + 128;
        }

        inline int64_t v() const
        {
         ...
         **/
        static RGBTColor FromYUV(T y, T u, T v)
        {
            int c = y - 16;
            int d = u - 128;
            int e = v - 128;
        ...
        {
            return RGBTColor(255, 255, 255);
        }

        static RGBTColor Red()
        {
            return RGBTColor(255, 0, 0);
        }

        static RGBTColor Orange()
        {
            return RGBTColor(255, 127, 0);
        }

        static RGBTColor Yellow()
        {
            return RGBTColor(255, 255, 0);
        }

        static RGBTColor Green()
        {
            return RGBTColor(0, 255, 0);
        }

        static RGBTColor Cyan()
        {
            return RGBTColor(0, 255, 255);
        }

        static RGBTColor Blue()
        {
            return RGBTColor(0, 0, 255);
        }

        static RGBTColor Indigo()
        {
            return RGBTColor(111, 0, 255);
        }

        static RGBTColor Violet()
        {
            return RGBTColor(143, 0, 255);
        }
