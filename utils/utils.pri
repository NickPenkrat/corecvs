# This file must be included for any external usage of qt4-utils library!
#
...
contains(TARGET, qt4-utils) {
    ...
    # The "UTILS_INTDIR" path should be known for other projects that use "qt4-utils"!
    # For the qt4-utils itself it's set automatically.
    win32 {
        UTILS_INTDIR = $$UTILSDIR/../../../.obj/qt4-utils/$$BUILD_CFG_NAME
    } else {
        UTILS_INTDIR = $$UTILSDIR/../../../.obj/qt4-utils
    }
    # this is needed as some new sources of qt4-utils use ui-sources from this project!
    INCLUDEPATH += $$UTILS_INTDIR                       # add autogenerated ui* headers of qt4-utils into include path for the current project

    UTILS_TARGET_NAME = qt4-utils
